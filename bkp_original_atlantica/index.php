...
<title>Bienvenido :: Su cuenta ha sido creada en forma exitosa</title>
<STYLE>
<!--
...
<table width="750" height="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="border-bottom: 1px solid #6A0000; border-left: 1px solid #990000; border-right: 1px solid #990000; ">
	<tr>
    	...
    	<tr>
    		<td width="130" align="right" valign="bottom"><img src="new_img/world_1.gif" width="106" height="70" alt="Panel de Control de Hosting" /></td>
    		<td class="HeadLogo" align="right">
			&nbsp;</td>
    		<td class="HeadLogo" align="right" width="10">&nbsp;</td>
    		</tr>
    	</table></td>
	</tr>
	<tr>
    	...
    	<tr>
        	...
        	<tr>
          	<td align="left" valign="top" class="Items"><div align="justify">Podr&aacute; modificar este contenido alojando los archivos de su sitio en la carpeta <strong>public_html/</strong><br />
         				de su cuenta. Para ello utilice un cliente de FTP de su preferencia configurando el mismo de acuerdo a los datos suministrados por 
				<b><a target="_blank" href="http://www.atlanticadigital.net/">
				<font color="#666666">AtlanticaDigital.net</font></a></b> Si decide utilizar MS FrontPage para publicar su sitio, aseg&uacute;rese primero que las extensiones de FrontPage se encuentren correctamente instaladas ingresando al panel de control para comprobarlo.</div></td>
        		</tr>
        	<tr>
          	<td align="left" valign="top" class="Items"><div align="justify">Para acceder a su panel de control haga <a href="http://<?php echo $_SERVER['SERVER_ADDR']; ?>:2082/" target="_blank">click aqu&iacute;</a> y utilice los datos de acceso que recibi&oacute; de su proveedor.<br />
        	...
        	<tr>
          	<td align="left" valign="top" class="Listado">* Parkeo de dominios / Administraci&oacute;n de Sub-Dominios.<br />
          		...
          		* Completo pack de aplicaciones web autoinstalables para utilizar en su sitio.</td>
        		</tr>
        	<tr>
	...
	<tr>
		<td height="10" align="center" valign="middle" class="Pie">Panel de Control de Hosting - Todos los derechos Reservados</td>
	</tr>
</table>
</body>
</html>